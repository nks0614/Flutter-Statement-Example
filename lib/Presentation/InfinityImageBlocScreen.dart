...
import '../Application/VerticalInfinityBloc.dart';
import '../Application/VerticalInfinityEvent.dart';
import '../Application/VerticalInfinityState.dart';
import '../Model/VerticalImageType.dart';
import 'InfinityImageErrorScreen.dart';
...
class InfinityImageBlocScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (_) => VerticalInfinityBloc()..add(VerticalInitImagesEvent())),
