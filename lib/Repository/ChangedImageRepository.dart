...
class ChangedImageRepository {
  static final ChangedImageRepository instance = ChangedImageRepository._internal();
  ...
  Future<String?> fetchImage({
    ...
    try {
      http.Response _response = await http.get(Uri.parse('https://picsum.photos/v2/list?page=$pageNo&limit=1'));
